...
public enum AdvancedLunarPanelTier implements ITier {
    ...
    private AdvancedLunarPanelTier(BaseTier baseTier, int defaultMultiplier) {
    ...
    public int getMultiplier() {
        return EMConfig.general.getAdvancedLunarGeneratorMultiplier(this);
    }
