...
public class GuiLunarGenerator<TILE extends TileEntityLunarGenerator> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiLunarGenerator(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiStateTexture(this, 18, 35, tile::canSeeSun, MekanismGenerators.rl(ResourceType.GUI.getPrefix() + "no_sun.png"),
              MekanismGenerators.rl(ResourceType.GUI.getPrefix() + "sees_sun.png")));
    }
