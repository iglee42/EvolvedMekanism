...
public class EMGenBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<TileEntityLunarGenerator, Generator<TileEntityLunarGenerator>>, ItemBlockTooltip<BlockTileModel<TileEntityLunarGenerator, Generator<TileEntityLunarGenerator>>>>
            LUNAR_GENERATOR = BLOCKS.register("lunar_generator",
            () -> new BlockTileModel<>(EMGenBlockTypes.LUNAR_GENERATOR, props -> props.mapColor(MapColor.COLOR_BLUE)),
