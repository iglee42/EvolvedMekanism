...
public class GuiLunarNeutronActivator extends GuiConfigurableTile<TileEntityLunarNeutronActivator, MekanismTileContainer<TileEntityLunarNeutronActivator>> {

    public GuiLunarNeutronActivator(MekanismTileContainer<TileEntityLunarNeutronActivator> container, Inventory inv, Component title) {
