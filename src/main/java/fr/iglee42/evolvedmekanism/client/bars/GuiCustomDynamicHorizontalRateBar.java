package fr.iglee42.evolvedmekanism.client.bars;
...
//Copied from mekanism's code but removed the final modifier on color function
public class GuiCustomDynamicHorizontalRateBar extends GuiBar<IBarInfoHandler> {
