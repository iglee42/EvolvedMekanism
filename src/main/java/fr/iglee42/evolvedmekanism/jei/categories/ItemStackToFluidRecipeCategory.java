...
public class ItemStackToFluidRecipeCategory extends BaseRecipeCategory<ItemStackToFluidRecipe> {
    ...
    public ItemStackToFluidRecipeCategory(IGuiHelper helper, RecipeType<ItemStackToFluidRecipe> recipeType, IItemProvider provider, boolean isConversion) {
        this(helper, recipeType, provider.getTextComponent(), createIcon(helper, provider), isConversion);
    }

    public ItemStackToFluidRecipeCategory(IGuiHelper helper, RecipeType<ItemStackToFluidRecipe> recipeType, Component component, IDrawable icon,
