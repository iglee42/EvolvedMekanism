...
public class EMItems {
    ...
    public static final ItemRegistryObject<ItemMaxTierInstaller> MAX_TIER_INSTALLER = ITEMS.register("max_tier_installer", ItemMaxTierInstaller::new);
    ...
    public static final ItemRegistryObject<ItemPortableHazmatSuit> PORTABLE_HAZMAT_SUIT =
            ITEMS.register("portable_hazmat_suit", ItemPortableHazmatSuit::new);
    ...
    private static ItemRegistryObject<ItemQIODrive> registerQIODrive(String name, Supplier<QIODriveTier> tierSupplier) {
        return ITEMS.register("qio_drive_" + name, properties -> new ItemQIODrive(resolveQIODriveTier(name, tierSupplier), properties));
    }
