...
public class EMBlockStateProvider extends BlockStateProvider {
    ...
    private void registerRemaining(Block block, String path) {
        ...
        if (path.endsWith("_personal_barrel")) {
            ...
            facingHorizontal(block, new ResourceLocation("mekanism", "block/personal_chest"), false);
        } else if (path.endsWith("_energy_cube")) {
            energyCube(block, tier);
        } else if (path.endsWith("_fluid_tank")) {
            activeOnly(block, new ResourceLocation("mekanism", "block/fluid_tank"), new ResourceLocation("mekanism", "block/fluid_tank_active"), false);
    ...
    private void ledCube(String modelPath, String all, String led) {
        models().withExistingParent(modelPath, new ResourceLocation("mekanism", "block/template/cube_all_led"))
    ...
    private void barrel(Block block, String tier) {
        models().withExistingParent("block/personal_barrel/" + tier, mcLoc("block/cube_bottom_top"))
                .texture("bottom", new ResourceLocation("mekanism", "block/personal_barrel/bottom"))
    ...
    private void energyCube(Block block, String tier) {
        models().withExistingParent("block/energy_cube/" + tier, new ResourceLocation("mekanism", "block/energy_cube/base"))
    ...
    private void chemicalTank(Block block, String tier) {
        models().withExistingParent("block/chemical_tank/" + tier, new ResourceLocation("mekanism", "block/chemical_tank/base"))
    ...
    private void bin(Block block, String tier) {
        models().withExistingParent("block/bin/" + tier, new ResourceLocation("mekanism", "block/bin/basic"))
                .texture("led", modLoc("block/bin/" + tier + "_led"))
                .texture("side", modLoc("block/bin/" + tier + "_side"))
                .texture("back", modLoc("block/bin/" + tier + "_back"));
        models().withExistingParent("block/bin/active/" + tier, new ResourceLocation("mekanism", "block/bin/active/basic"))
                .texture("led", modLoc("block/bin/" + tier + "_led"))
                .texture("side", modLoc("block/bin/" + tier + "_side"))
                .texture("back", modLoc("block/bin/" + tier + "_back"));
    ...
    private void inductionCell(Block block, String path, String tier) {
        models().withExistingParent("block/induction/cell/" + tier, new ResourceLocation("mekanism", "block/induction/cell/basic"))
                .renderType("cutout")
    ...
    private void inductionProvider(Block block, String path, String tier) {
        models().withExistingParent("block/induction/provider/" + tier, new ResourceLocation("mekanism", "block/induction/provider/base"))
                .renderType("cutout")
                .texture("particle", modLoc("block/" + path))
                .texture("all", modLoc("block/" + path))
                .texture("glow", new ResourceLocation("mekanism", "block/induction_provider_glow"))
    ...
    private void transmitter(Block block, String modelPath, String parent, String path) {
        ...
        String opaqueSide = textureExists("block/models/multipart/opaque/" + path + "_vertical")
                ...
                : side;
        models().withExistingParent(modelPath, new ResourceLocation(parent))
