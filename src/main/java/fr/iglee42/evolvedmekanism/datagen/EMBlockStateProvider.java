...
public class EMBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        EMFluids.FLUIDS.getBlockEntries().forEach(holder -> {
            ...
            simpleBlock(holder.get(), models().getExistingFile(modLoc(modelPath)));
        });
    }
    ...
    private void factory(FactoryTier tier, FactoryType type, boolean alloying) {
        ...
        boolean emLed = LED_UV.containsKey(tierName);
        factoryModel(typeName, tierName, false, alloying, emLed);
        factoryModel(typeName, tierName, true, alloying, emLed);
