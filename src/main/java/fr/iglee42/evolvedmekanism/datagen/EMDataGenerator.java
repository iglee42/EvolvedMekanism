...
public final class EMDataGenerator {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(server, new EMChemicalTags(output, lookup, existing));
        generator.addProvider(server, new EMRecipeProvider(output, lookup));
        ...
        generator.addProvider(client, new EMSpriteSourceProvider(output, lookup, existing));
