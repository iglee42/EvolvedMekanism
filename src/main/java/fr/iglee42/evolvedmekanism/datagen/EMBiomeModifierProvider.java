...
public class EMBiomeModifierProvider implements DataProvider {
    ...
    public CompletableFuture<?> run(CachedOutput cache) {
        ...
        JsonObject noctis = new JsonObject();
        noctis.addProperty("type", "neoforge:add_features");
        noctis.addProperty("biomes", "#mekanism:spawn_ores");
        JsonArray noctisFeatures = new JsonArray();
        noctisFeatures.add("evolvedmekanism:ore_noctis");
        noctisFeatures.add("evolvedmekanism:ore_noctis_buried");
        noctis.add("features", noctisFeatures);
        noctis.addProperty("step", "underground_ores");
        tasks.add(DataProvider.saveStable(cache, noctis, pathProvider.json(EvolvedMekanism.rl("noctis"))));
