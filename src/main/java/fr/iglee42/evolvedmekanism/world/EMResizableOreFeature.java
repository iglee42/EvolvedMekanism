...
//Modified copy of mekanism's ResizableOreFeature but to support EMResizableOreFeatureConfig
public class EMResizableOreFeature extends Feature<EMResizableOreFeatureConfig> {

    public EMResizableOreFeature() {
        super(EMResizableOreFeatureConfig.CODEC);
    }
    ...
    @Override
    public boolean place(@NotNull FeaturePlaceContext<EMResizableOreFeatureConfig> context) {
        RandomSource random = context.random();
        BlockPos pos = context.origin();
        WorldGenLevel world = context.level();
        EMResizableOreFeatureConfig config = context.config();
    ...
    protected boolean doPlace(WorldGenLevel world, RandomSource random, EMResizableOreFeatureConfig config, double xMin, double xMax, double zMin, double zMax, double yMin,
